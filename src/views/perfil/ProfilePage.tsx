...
export default function ProfilePage() {
    ...
    const perfumesPaginados = adminPerfumes.slice(
        (paginaPerfumes - 1) * ITEMS_POR_PAGINA,
        paginaPerfumes * ITEMS_POR_PAGINA
    );
    const perfumistasPaginados = adminPerfumistas.slice(
    ...
    const renderAdminTables = () => (
        <div className="space-y-10">
            <div className="flex flex-wrap gap-3">
                <button
                    type="button"
                    className={`btn ${adminView === "perfumes"
                ...
                <button
                    type="button"
                    className={`btn ${adminView === "perfumistas"
                        ? "btn-primary text-primary-content"
                        : "btn-outline border-base-content/30 text-base-content hover:border-primary hover:bg-base-200"
                        }`}
            ...
            {adminView === "perfumes" ? (
                <section>
                    ...
                    <Paginacion
                        totalItems={adminPerfumes.length}
                ...
                <section>
                    ...
                    <Paginacion
                        totalItems={adminPerfumistas.length}
                        itemsPorPagina={ITEMS_POR_PAGINA}
